...
module cpu(
    ...
    // Execute stage
    wire [31:0] ALU_result_ex_w, jump_target_ex_w, jump_target_early_w;
    ...
    execute_stage EX_STAGE (
        ...
        .ALU_result_out(ALU_result_ex_w), .jump_target_out(jump_target_ex_w),
        .jump_target_early_out(jump_target_early_w), .instruction_out(instr_ex_w),
    ...
    hazard HDU (
        ...
        .rst(rst),
        .PC_id(PC_fetch_w),
        .imm_id(immediate_id_w),
        .branch_id(branch_id_w),
        .jump_id(jump_id_w),
        .jalr_id(jalr_id_w),
        .memRead_ex(memRead_ex_w),
        .branch_ex(branch_ex_w),
        .jalr_ex(jalr_ex_w),
        .br_result_ex(PCSel_early_w),
        .br_predict_ex(br_predict_reg),
        .PC_ex(PC_id_w),
        .ALU_result_ex(jump_target_early_w),
